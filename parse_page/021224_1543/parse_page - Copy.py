...
def main():
  ...
  while continue_file_read_lines == True:
    try:
      ...
      if curr_tab != "":
        ...
        pos_branch_open_div = curr_line.find('<div class="Collapsible')
        if pos_branch_open_div != -1:
          in_branch = True
        ...
        curr_text = get_html_line_text(curr_line, search_text, '<')
        if curr_text != "not found" and in_branch == True:
  ...
  print(ary_ary_tab_branches)
  final_str = ''
  for ary_tab_branches in ary_ary_tab_branches:
    #None
